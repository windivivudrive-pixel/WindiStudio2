...
async def upload_image(
    ...
    *,
    ...
    # Uploads do not consume generation credits and do not require a generation
    # reCAPTCHA token. The uploaded asset is then selected in the Flow UI.
    result = await bridge.api_request(
        ENDPOINTS["upload_image"], body, captcha_action=None,
        meta={"upload_filename": os.path.basename(image_path)},
    )
