        ...
        <section className="py-24 relative overflow-hidden bg-[#050505] border-t border-white/5">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    {/* LEFT COLUMN: SHOP OWNERS (FOMO) */}
                    <div className="relative group rounded-3xl p-1 bg-gradient-to-b from-red-500/20 via-white/5 to-transparent">
                    ...
                    {/* RIGHT COLUMN: CREATORS (Exclusive) */}
                    <div className="relative group rounded-3xl p-1 bg-gradient-to-b from-amber-200/20 via-white/5 to-transparent">
