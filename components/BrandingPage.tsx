...
export const BrandingPage: React.FC<BrandingPageProps> = ({
    ...
    return (
        <div className="w-full h-full p-4 lg:p-10 flex flex-col max-w-6xl mx-auto overflow-y-auto lg:overflow-visible custom-scrollbar pb-20 lg:pb-10">
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                {/* PREVIEW PANEL */}
                {/* Mobile: Order 1 (Top) & Sticky. Desktop: Order 2 (Right) & Static */}
                <div className="order-1 lg:order-2 lg:col-span-2 sticky top-0 z-30 lg:static">
                    <div className="glass-panel p-2 rounded-[24px] lg:rounded-[32px] w-full h-[25vh] lg:h-auto lg:min-h-[300px] flex flex-col shadow-2xl bg-black/80 lg:bg-transparent backdrop-blur-xl lg:backdrop-blur-md transition-all">
                        <div className="flex-1 bg-black/40 rounded-[20px] lg:rounded-[24px] relative overflow-hidden flex items-center justify-center border border-white/5">
                            {/* Placeholder Image */}
                            <img
                                src="https://pub-2c62533bc7f74fcc91ecf8acc704d044.r2.dev/4f018bf9-b2c6-4075-8a21-9018efcb003f/1764607798977_0.jpg"
                                alt="Preview Base"
